...
SRCS = builtin/ft_cd.c builtin/ft_echo.c builtin/ft_env.c builtin/ft_exit.c \
       ...
       parsing/extract.c parsing/handle_expands.c parsing/lexer.c parsing/main.c parsing/parsing_mini.c parsing/mini_functions.c parsing/node.c parsing/parsing.c parsing/utility_parsing.c parsing/utils.c \
