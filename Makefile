CC = cc
CFLAGS = -Wall -Wextra -Werror -I./libft -I./parsing -I./exec -I./builtin
...
SRCS = builtin/ft_cd.c builtin/ft_echo.c builtin/ft_env.c builtin/ft_exit.c \
       ...
       parsing/extract.c parsing/handle_expands.c parsing/lexer.c parsing/main.c parsing/mini_functions.c parsing/node.c parsing/parsing.c parsing/test.c parsing/utility_parsing.c parsing/utils.c
